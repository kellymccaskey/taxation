...
\begin{figure}[H]
\begin{center}
\includegraphics[scale = 0.60]{figs/Rplot_mecomparison.pdf}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale = 0.6]{figs/Rplot_hatvalues_ipf.pdf}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale = 0.6]{figs/Rplot_hatvalues_fdi.pdf}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale = 0.8]{figs/Rplot_coefficient_estimate_comparison_ipf.pdf}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale = 0.8]{figs/Rplot_coefficient_estimate_comparison_fdi.pdf}
